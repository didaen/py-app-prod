...
function sudahDijawab() {
	...
	if(document.getElementsByClassName("pertanyaan") !== null && document.getElementById('judul').value !== 'Belajar') {
...
function userMenjawab() {
	...
	// Jika ada class pertanyaan yang mana merupakan class yang ada pada card kategori Latihan Soal
	if(document.getElementsByClassName("pertanyaan") !== null && document.getElementById('judul').value == 'Latihan Soal') {
