...
<div>
    ...
    <div>
        ...
        <!-- ___FORM DAN ISI___ -->
        <div class="flex flex-col text-base text-justify bg-white text-gray-700 px-4 sm:px-8 py-8 border-dashed border-l-8 border-r-8 border-blue-1700" id="latihan">
                ...
                <div>
                    ...
                    <div class="text-base bg-gray-100 text-center rounded p-1 border-2 border-white mt-2 hidden" id="keyboard">
                        <div class="grid grid-cols-13 lg:grid-cols-25 italic items-center katex-math-italic">
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="α">α</button>
                            ...
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="o">o</button>
                            ...
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="ς">ς</button>
                            ...
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="υ">υ</button>
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="ϕ">ϕ</button>
                        ...
                        <div class="grid grid-cols-13 lg:grid-cols-25 items-center times-new-roman">
                            ...
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="Σ">Σ</button>
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="Τ">Τ</button>
                            <button type="button" class="greek-alphabet bg-gray-200 border border-white rounded hover:bg-gray-300 hover:text-white" value="Υ">Y</button>
    ...
    <div>
        ...
        <div class="w-full text-gray-700 bg-red-300 hidden text-center text-sm px-4 py-2" id="peringatan">
            <p>
                Geser untuk menampilkan <a style="display: inline; color: #60a5fa; font-weight: bold; text-decoration: underline;" href="https://youtu.be/5x2QFdnJh9A" target="_blank">seluruh persamaan</a>.
            </p>
        </div>
        ...
        <form method="post" id="form-card-internal">
            ...
            <div class="w-full grid grid-rows-2 gap-2 sm:gap-0 grid-cols-3 sm:flex sm:flex-row mt-2">
                ...
                <div class="row-start-2 sm:flex-none">
                    <button type="reset" class="btn-kecil-merah" id="reset">
                        Reset
                    </button>
                </div>
                <!-- AKHIR TOMBOL RESET -->
