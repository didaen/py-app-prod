<div class="mb-10">
    ...
    <div class="flex flex-col sm:flex-row items-center gap-4 px-4 sm:px-8 py-8 bg-white border-dashed border-l-8 border-r-8 border-blue-1000">
        <div>
...
<div class="mb-10">
    ...
    <div class="bg-white text-gray-600 px-4 sm:px-8 py-8 border-dashed border-l-8 border-r-8 border-blue-1000">
