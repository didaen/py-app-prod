<div class="mb-10">
    ...
    <div>
        ...
        <div class="p-4 bg-white border-dashed border-l-8 border-r-8 border-blue-1700">
    ...
    <div>
        ...
        <div class="flex sm:hidden flex-col gap-4 p-4 bg-white border-dashed border-l-8 border-r-8 border-blue-1700">
        ...
        <div class="hidden sm:flex flex-col gap-4 p-4 bg-white border-dashed border-l-8 border-r-8 border-blue-1700">
