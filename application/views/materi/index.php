        ...
        <div class="mb-4">
            <div class="flex flex-row justify-between space-x-4">
                ...
                <div class="flex flex-col pt-2">
                    ...
                    <label for="cpl-btn" class="text-sm cursor-pointer px-1 bg-blue-500 hover:bg-blue-400 active:bg-blue-500 focus:bg-blue-500 text-white text-center rounded transition duration-300" id="label-cpl">show</label>
                </div>
        ...
        <div class="mb-4">
            <div class="flex flex-row justify-between space-x-4">
                ...
                <div class="flex flex-col">
                    ...
                    <label for="cpmk-btn" class="text-sm cursor-pointer px-1 bg-blue-500 hover:bg-blue-400 active:bg-blue-500 focus:bg-blue-500 text-white text-center rounded transition duration-300" id="label-cpmk">show</label>
                </div>
        ...
        <div class="mb-4">
            <div class="flex flex-row justify-between space-x-4">
                ...
                <div class="flex flex-col">
                    ...
                    <label for="cd-btn" class="text-sm cursor-pointer px-1 bg-blue-500 hover:bg-blue-400 active:bg-blue-500 focus:bg-blue-500 text-white text-center rounded transition duration-300" id="label-cd">show</label>
                </div>
        ...
        <div class="mb-4">
            <div class="flex flex-row justify-between space-x-4">
                ...
                <div class="flex flex-col">
                    ...
                    <label for="sm-btn" class="text-sm cursor-pointer px-1 bg-blue-500 hover:bg-blue-400 active:bg-blue-500 focus:bg-blue-500 text-white text-center rounded transition duration-300" id="label-sm">show</label>
                </div>
